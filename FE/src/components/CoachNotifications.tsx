...
export const CoachNotifications = () => {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, type: "booking", icon: Calendar, title: "New Session Booking", message: "5 players registered for Advanced Throwing Workshop", time: "10 min ago", unread: true, color: "purple" },
    { id: 2, type: "reminder", icon: Clock, title: "Session Reminder", message: "Cutting Fundamentals session starts in 30 minutes", time: "30 min ago", unread: true, color: "orange" },
    { id: 3, type: "feedback", icon: CheckCircle, title: "Feedback Received", message: "Players rated your last session 4.8/5.0", time: "2 hours ago", unread: true, color: "green" },
    { id: 4, type: "assignment", icon: Clipboard, title: "New Assignment", message: "Admin assigned you to Youth Development program", time: "1 day ago", unread: false, color: "blue" },
    { id: 5, type: "cancellation", icon: AlertCircle, title: "Session Cancelled", message: "Defensive Strategies session cancelled due to weather", time: "2 days ago", unread: false, color: "red" }
  ]);
              ...
              {notifications.length === 0 ? (
                ...
                <div className="divide-y divide-border">
                  {notifications.map((notif) => (
                    <div
                      key={notif.id}
                      className={`p-4 hover:bg-muted/50 transition-colors ${notif.unread ? 'bg-purple-500/5' : ''}`}
                    >
