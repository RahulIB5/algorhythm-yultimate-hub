...
const PlayerAIChat: React.FC<PlayerAIChatProps> = ({
  playerStats,
  recentMatches = [],
  performanceGoals = [],
  currentChallenges = []
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      text: "🏆 Hi there! I'm your Ultimate Frisbee AI performance coach! I can help you improve your throws, game awareness, and overall performance. What would you like to work on today?",
      sender: "ai",
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      console.log("📡 Calling AI API with:", { question: currentInput, context });

      const response = await aiAPI.playerAssistant({
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <Card className={`w-96 ${isMinimized ? 'h-20' : 'h-[600px]'} transition-all duration-300 shadow-2xl bg-white border-0 overflow-hidden`}>
        {/* Header */}
